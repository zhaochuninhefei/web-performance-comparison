...
public class PostgresPerformanceTest {
    ...
    private static final String JDBC_CLASS_NAME = "org.postgresql.Driver";
    private static final String JDBC_URL = "jdbc:postgresql://localhost:5432/db_pm_postgres";
    ...
    public static void main(String[] args) {
        PostgresPerformanceTest me = new PostgresPerformanceTest();
        ...
        me.executeDDL("DROP INDEX tb_order_idx01");
