...
public class TiDBPerformanceTest {

    private static final String JDBC_CLASS_NAME = "com.mysql.cj.jdbc.Driver";
    private static final String JDBC_URL = "jdbc:mysql://localhost:4000/db_pm_tidb?useUnicode=true&characterEncoding=UTF-8&useSSL=false&rewriteBatchedStatements=true";
    ...
    public static void main(String[] args) {
        TiDBPerformanceTest me = new TiDBPerformanceTest();
        ...
        me.executeDDL("CREATE INDEX `tb_order_idx01` ON `db_pm_tidb`.`tb_order` (`custom_number`, `product_number` DESC)");
        me.selectOrderWithOrderBy();
        me.executeDDL("ALTER TABLE `db_pm_tidb`.`tb_order` DROP INDEX `tb_order_idx01`");
